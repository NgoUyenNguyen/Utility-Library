...
namespace NgoUyenNguyen.Behaviour.SM
{
    ...
    public abstract class StateManager<EState> : MonoBehaviour where EState : Enum
    {
        ...
        /// </summary>
        private Dictionary<EState, State<EState>> statesDictionary = new Dictionary<EState, State<EState>>();
        ...
        private State<EState> stateBuffer { get; set; }
        ...
        private void TransitionToState(State<EState> nextState)
        {
        ...
        protected void AddStates(params State<EState>[] states)
        {
        ...
        protected void RemoveStates(params State<EState>[] states)
        {
            foreach (var state in states)
            {
                if (!statesDictionary.ContainsKey(state.stateKey))
        ...
        /// <returns></returns>
        protected State<EState> GetState(EState stateKey)
        {
            if (!statesDictionary.ContainsKey(stateKey))
            {
